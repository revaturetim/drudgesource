...
static final private String HELP = "-HELP";
	...
	static void print(final String key) {
		...
		System.out.printf("%-10s This will test to see if the page is in the " + FileNames.include + " file\n", "-I");
		//System.out.printf("%-10s \n", "-J");
		...
		//System.out.printf("%-10s \n", "-W");
		System.out.printf("%-10s This will test to see if you page is in the " + FileNames.exclude + " file\n", "-X");
		//System.out.printf("%-10s \n", "-Y");
		//System.out.printf("%-10s \n", "-Z");
		}
